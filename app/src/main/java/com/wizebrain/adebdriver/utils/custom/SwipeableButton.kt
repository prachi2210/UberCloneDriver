package com.wizebrain.adebdriver.utils.custom
...
open class SwipeableButton @JvmOverloads constructor(
     ...
     * */
    var uncheckedIcon: Drawable? = ContextCompat.getDrawable(context, R.drawable.ic_start_taxi)
        set(uncheckedIcon) {
            field = uncheckedIcon
            updateState()
        }
    ...
    private fun animateToggleToStart() {
        ...
        colorAnimation.addUpdateListener { animator ->
            //buttonSwipeableTv.setTextColor(animator.animatedValue as Int)
            }
